<template>
  <div class="clearfix">
    ...
    <div class="nav-background  d-none d-md-block">
      <div class="container">
        <Navbar></Navbar>
      </div>
    </div>
    <div style="width:100%;background:#c4d4e4;padding-bottom:60px;">
    ...
    <div class="" style="background:#333e49;padding-bottom:60px">
      <div class="container">
        <div class="row">
          <div class='col-12 col-lg-6 l'>
            <First></First>
    ...
    <div class="container">
      <div class="row">
        <div class='col-12 col-lg-5 li'>
          <Second></Second>
        </div>
        <div class="col-12 col-lg-6 li">
          <Third></Third>
        </div>
      </div>
    </div>
    <div style="width:100%;background:#333e49;padding-top:20px;padding-bottom:50px">
      <div class="container">
        <Titles t1="新品展示" style="margin:20px auto"></Titles>
        <div class="row">
          <swiper-page1></swiper-page1>
        </div>
      </div>
      <div class="container">
...
<script type="text/ecmascript-6">
  ...
  import SwiperPage1 from 'components/SwiperPage1.vue'
